...
#pragma endregion
	void Scene_W2::Initialize()
	{
		...
		//AddPointLight(Vector3{ 0.f, 5.f, -5.f }, 70.f, colors::White); //light behind orbs
	...
	void Scene_W3Test::Initialize()
	{
		//Intermediary
		m_Camera.origin = { 0.f, 1.f, -5.f };
		m_Camera.fovAngle = 45.f;

		const auto matLambert_DarkBlue = AddMaterial(new Material_Lambert(colors::Blue, 1.f));
		//Plane
